...
def test_drawing_bridge():
    ...
    try:
        ...
        bridge.start_video_capture("output/log/test_drawing_session.mp4")
        ...
        for i in range(num_tests):
            ...
            # Capture the result
            output_filename = f"output/log/test_result_step_{i+1}.png"
        ...
        bridge.capture_canvas("output/log/test_final_result.png")

        print("\n🎉 Test completed successfully!")
        print("Files generated:")
        print("  - output/log/test_drawing_session.mp4 (video)")
        print("  - output/log/test_result_step_1.png")
        print("  - output/log/test_result_step_2.png")
        print("  - output/log/test_result_step_3.png")
        print("  - output/log/test_final_result.png")
