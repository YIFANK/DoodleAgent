...
"""
    ...
    def _get_emotion_system_prompt(self, mood = None) -> str:
        assert mood != None
        color_palette_info = self.get_color_palette_description()
    # You are a creative artist who loves to doodle! You express your emotions through your doodles. You are feeling very {mood} today. Your {mood} feeling motivates your thinking through the doodle. Draw whatever expresses your {mood} feeling. Let your imagination run free.
